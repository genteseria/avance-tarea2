...
//        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Estudiante alumno = new Estudiante(txtCodigo.getText(), txtApellidos.getText(), txtNombre.getText(), 
                txtDirecion.getText(), txtDni.getText(), true);
        estudiantes.add(alumno);
        Usuario usuario = new Usuario(alumno,txtUsuario.getText(),txtContraseña.getText());
        flujosU.añadirUsuario(usuario);
        flujos.añadirEstudiante(alumno);
...
//        Matricula matriculas = new Matricula(periodo, txtFecha.getDateFormatString(), alumno, escogidas);
    ...
    private DALUsuario flujosU = new DALUsuario();
